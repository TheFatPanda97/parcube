    ...
    <View style={styles.outerContainer}>
      <SafeAreaView style={styles.innerContainer}>
        <ScrollView>
          ...
          <Text style={[styles.allText, styles.titleText]}>How to Host Parking</Text>

          <Text style={[styles.allText, styles.stepText]}>Step 1</Text>
          <Text style={styles.descriptionText}>
            Go to the hosting tab and click on the button that says "Host Parking"
          </Text>
          <Image source={example_img} style={styles.imgStyle} />

          <Text style={[styles.allText, styles.stepText]}>Step 2</Text>
          <Text style={styles.descriptionText}>Enter your details to be listed as a Host</Text>
          <Image source={example_img} style={styles.imgStyle} />
        </ScrollView>
      </SafeAreaView>
    </View>
